...
public interface ChurujiluService extends IService<ChurujiluEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ChurujiluEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ChurujiluEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ChurujiluEntity> wrapper);
