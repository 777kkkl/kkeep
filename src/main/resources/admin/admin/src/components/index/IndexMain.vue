<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"85px 0 0 190px","margin":"0","position":"relative","background":"#E9EAEE","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0px rgba(0, 0, 0, .3)","padding":"0 20px 0","alignItems":"center","color":"#000","display":"flex","justifyContent":"flex-end","top":"5px","left":"5px","background":"#fff","width":"calc(100% - 10px)","fontSize":"16px","position":"fixed","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 20px","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 40px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
