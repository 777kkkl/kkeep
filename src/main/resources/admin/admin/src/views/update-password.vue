<template>
	<div :style='{"padding":"20px 10px 20px 40px"}'>
		<el-form
			:style='{"padding":"20px 0","borderColor":"#eee","borderStyle":"solid","borderWidth":"0px 0 0","background":"#fff"}'
		...
		>
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0 0"}'>
				<el-button class="btn3" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"5px","background":"#FFA100","width":"auto","fontSize":"16px","minWidth":"130px","height":"40px"}' type="primary" @click="onUpdateHandler">
		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'waimaiyuan') {
					}
					if (this.$storage.get("sessionTable") == 'xiaoquguanliyuan') {
					}
					if (this.ruleForm.password != password) {
						this.$message.error("原密码错误");
						return;
